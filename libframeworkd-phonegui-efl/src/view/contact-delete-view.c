...
void contact_delete_yes_clicked(void *userdata, Evas_Object * obj,
				void *event_info);
void contact_delete_no_clicked(void *userdata, Evas_Object * obj,
			       void *event_info);
...
void
contact_delete_view_hide(struct ContactDeleteViewData *data)
{
...
static void
frame_delete_hide(void *userdata)
{
	struct ContactDeleteViewData *data =
		(struct ContactDeleteViewData *) userdata;
...
static void
frame_deleting_show(struct ContactDeleteViewData *data)
{
	struct Window *win = data->win;
