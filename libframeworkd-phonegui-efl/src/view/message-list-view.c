...
struct MessageListViewData {
	...
	Evas_Object *content_entry, *bt1, *bt2, *bt3, *hv, *bx, *button_answer,
		*button_delete;
...
static void message_list_view_new_clicked(struct MessageListViewData *data,
					  Evas_Object * obj, void *event_info);
static void message_list_view_show_clicked(struct MessageListViewData *data,
					   Evas_Object * obj, void *event_info);
static void message_list_view_delete_clicked(struct MessageListViewData *data,
					     Evas_Object * obj,
					     void *event_info);
static void message_list_view_answer_clicked(struct MessageListViewData *data,
					     Evas_Object * obj,
					     void *event_info);
static void message_list_view_message_deleted(struct MessageListViewData *data);
static void message_list_view_message_deleted_callback(struct
						       MessageListViewData
						       *data);
static void retrieve_messagebook_callback(GError * error, GPtrArray * messages,
...
static void
message_list_view_show_clicked(struct MessageListViewData *data,
			       Evas_Object * obj, void *event_info)
{
...
static void
message_list_view_message_deleted(struct MessageListViewData *data)
{
