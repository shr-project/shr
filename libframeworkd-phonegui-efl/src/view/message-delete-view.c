...
void message_delete_yes_clicked(void *userdata, Evas_Object * obj,
				void *event_info);
void message_delete_no_clicked(void *userdata, Evas_Object * obj,
			       void *event_info);
...
static void frame_delete_no_clicked(void *userdata, Evas_Object * obj,
				    void *event_info);
static void frame_delete_yes_clicked(void *userdata, Evas_Object * obj,
				     void *event_info);
...
struct MessageDeleteViewData *
message_delete_view_show(struct Window *win, GHashTable * options)
{
...
void
message_delete_view_hide(struct MessageDeleteViewData *data)
{
	g_slice_free(struct MessageDeleteViewData, data);
}

static void
delete_callback(GError * error, gpointer userdata)
{
	struct MessageDeleteViewData *data =
		(struct MessageDeleteViewData *) userdata;
...
static void
frame_delete_show(struct MessageDeleteViewData *data)
{
...
static void
frame_delete_hide(struct MessageDeleteViewData *data)
{
...
static void
frame_delete_no_clicked(void *userdata, Evas_Object * obj, void *event_info)
{
	struct MessageDeleteViewData *data =
		(struct MessageDeleteViewData *) userdata;
	window_destroy(data->win, NULL);
...
static void
frame_deleting_show(struct MessageDeleteViewData *data)
{
	struct Window *win = data->win;
