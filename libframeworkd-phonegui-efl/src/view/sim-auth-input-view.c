...
void sim_auth_keypad_clicked(struct SimAuthInputViewData *data,
			     Evas_Object * obj, char input);
void sim_auth_delete_clicked(struct SimAuthInputViewData *data,
			     Evas_Object * obj, void *event_info);
void sim_auth_ok_clicked(struct SimAuthInputViewData *data, Evas_Object * obj,
			 void *event_info);
...
struct SimAuthInputViewData *
sim_auth_input_view_show(struct Window *win, GHashTable * options)
{
...
void
sim_auth_input_view_hide(struct SimAuthInputViewData *data)
{
...
gboolean
pin_wrong_callback(struct SimAuthInputViewData *data)
{
...
int
reset_callback(struct SimAuthInputViewData *data)
{
	sim_auth_clear(data);
...
void
sim_auth_ok_clicked(struct SimAuthInputViewData *data, Evas_Object * obj,
		    void *event_info)
{
...
void
sim_auth_keypad_clicked(struct SimAuthInputViewData *data, Evas_Object * obj,
			char input)
{
	g_debug("MODE: %d", data->mode);
...
void
sim_auth_delete_clicked(struct SimAuthInputViewData *data, Evas_Object * obj,
			void *event_info)
{
	char *string;
	int *length;
...
static void
frame_input_show(struct SimAuthInputViewData *data)
{
...
static void
frame_input_hide(struct SimAuthInputViewData *data)
{
...
static void
frame_checking_show(struct SimAuthInputViewData *data)
{
...
static void
frame_pin_correct_show(struct SimAuthInputViewData *data)
{
...
static void
frame_pin_wrong_show(struct SimAuthInputViewData *data)
{
...
static void
frame_pins_different_show(struct SimAuthInputViewData *data)
{
...
static void
frame_puk_correct_show(struct SimAuthInputViewData *data)
{
...
static void
frame_puk_wrong_show(struct SimAuthInputViewData *data)
{
...
static void
frame_pin_invalid_length_show(struct SimAuthInputViewData *data)
{
