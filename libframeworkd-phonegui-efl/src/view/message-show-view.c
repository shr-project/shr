...
static void retrieve_callback(GError * error, char *status, char *number,
			      char *content, GHashTable * properties,
			      gpointer data);
static void retrieve_callback2(struct MessageShowViewData *data);
static void message_show_view_close_clicked(struct MessageShowViewData *data,
					    Evas_Object * obj,
					    void *event_info);
static void message_show_view_answer_clicked(struct MessageShowViewData *data,
					     Evas_Object * obj,
					     void *event_info);
static void message_show_view_delete_clicked(struct MessageShowViewData *data,
					     Evas_Object * obj,
					     void *event_info);
static void message_show_view_delete_callback(struct MessageShowViewData *data);
static void message_show_view_delete_callback_callback(struct
						       MessageShowViewData
						       *data);
static void message_show_view_call_clicked(struct MessageShowViewData *data,
					   Evas_Object * obj, void *event_info);
static void my_hover_bt_1(void *data, Evas_Object * obj, void *event_info);
static void message_show_view_new_contact_clicked(struct MessageShowViewData
						  *data, Evas_Object * obj,
						  void *event_info);


struct MessageShowViewData *
message_show_view_show(struct Window *win, GHashTable * options)
{
	assert(win != NULL);
	assert(options != NULL);
...
void
message_show_view_hide(struct MessageShowViewData *data)
{
...
static void
message_show_view_close_clicked(struct MessageShowViewData *data,
				Evas_Object * obj, void *event_info)
{
...
static void
message_show_view_call_clicked(struct MessageShowViewData *data,
			       Evas_Object * obj, void *event_info)
{
...
static void
message_show_view_delete_callback(struct MessageShowViewData *data)
{
