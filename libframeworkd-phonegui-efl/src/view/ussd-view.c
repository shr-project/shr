...
static void frame_ussd_close_clicked(struct UssdViewData *data,
...
void
ussd_view_hide(struct UssdViewData *data)
{
...
static void
frame_ussd_hide(struct UssdViewData *data)
{
	struct Window *win = data->win;
...
static void
frame_ussd_close_clicked(struct UssdViewData *data, Evas_Object * obj,
			 void *event_info)
{
