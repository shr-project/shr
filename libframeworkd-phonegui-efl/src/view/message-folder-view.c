...
static void message_folder_view_retrieve_messagebook_callback2(struct
							       MessageFolderViewData
							       *data);
static void messages_button_new_clicked(struct MessageFolderViewData *data,
					Evas_Object * obj, void *event_info);
static void messages_button_show_clicked(struct MessageFolderViewData *data,
					 Evas_Object * obj, void *event_info);


struct MessageFolderViewData *
message_folder_view_show(struct Window *win, GHashTable * options)
{
...
void
message_folder_view_hide(struct MessageFolderViewData *data)
{
...
static void
messages_button_new_clicked(struct MessageFolderViewData *data,
			    Evas_Object * obj, void *event_info)
{
...
static void
messages_button_show_clicked(struct MessageFolderViewData *data,
			     Evas_Object * obj, void *event_info)
{
