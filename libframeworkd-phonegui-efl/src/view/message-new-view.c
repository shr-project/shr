...
static void message_send_callback(GError * error, int transaction_index,
...
static void frame_content_close_clicked(struct MessageNewViewData *data,
					Evas_Object * obj, void *event_info);
static void frame_content_continue_clicked(struct MessageNewViewData *data,
					   Evas_Object * obj, void *event_info);
static void frame_content_content_changed(struct MessageNewViewData *data,
					  Evas_Object * obj, void *event_info);
...
static void frame_recipient_back_clicked(struct MessageNewViewData *data,
					 Evas_Object * obj, void *event_info);
static void frame_recipient_contact_add_clicked(struct MessageNewViewData *data,
						Evas_Object * obj,
						void *event_info);
static void frame_recipient_number_add_clicked(struct MessageNewViewData *data,
					       Evas_Object * obj,
					       void *event_info);
static void frame_recipient_delete_clicked(struct MessageNewViewData *data,
					   Evas_Object * obj, void *event_info);
static void frame_recipient_continue_clicked(struct MessageNewViewData *data,
					     Evas_Object * obj,
					     void *event_info);
static void frame_recipient_process_recipient(gpointer _properties,
					      gpointer _data);
static void frame_recipient_send_callback(GError * error, int transaction_index,
...
static void frame_contact_add_back_clicked(struct MessageNewViewData *data,
					   Evas_Object * obj, void *event_info);
static void frame_contact_add_add_clicked(struct MessageNewViewData *data,
					  Evas_Object * obj, void *event_info);
...
static void frame_number_add_add_clicked(struct MessageNewViewData *data,
					 Evas_Object * obj, void *event_info);
static void frame_number_add_back_clicked(struct MessageNewViewData *data,
					  Evas_Object * obj, void *event_info);

static void frame_close_show(struct MessageNewViewData *data);
static void frame_close_hide(struct MessageNewViewData *data);
static void frame_close_yes_clicked(struct MessageNewViewData *data,
				    Evas_Object * obj, void *event_info);
static void frame_close_no_clicked(struct MessageNewViewData *data,
				   Evas_Object * obj, void *event_info);
...
void
message_new_view_hide(struct MessageNewViewData *data)
{
	//g_slice_free(struct MessageNewViewData, data);
}

static void
message_send_callback(GError * error, int transaction_index,
		      struct MessageNewViewData *data)
{
...
static void
frame_content_close_clicked(struct MessageNewViewData *data, Evas_Object * obj,
			    void *event_info)
{
...
static void
frame_recipient_hide(struct MessageNewViewData *data)
{
...
static void
frame_recipient_back_clicked(struct MessageNewViewData *data, Evas_Object * obj,
			     void *event_info)
{
	data->mode = MODE_CONTENT;
...
static void
frame_recipient_contact_add_clicked(struct MessageNewViewData *data,
				    Evas_Object * obj, void *event_info)
{
...
static void
frame_recipient_number_add_clicked(struct MessageNewViewData *data,
				   Evas_Object * obj, void *event_info)
{
...
static void
frame_recipient_continue_clicked(struct MessageNewViewData *data,
				 Evas_Object * obj, void *event_info)
{
	if (data->recipients->len) {
		...
		for (i = 0; i < data->recipients->len; i++) {
			...
			// TODO: Remove strdup
			ogsmd_sms_send_message(strdup(number),
					       strdup(data->content), options,
					       frame_recipient_send_callback,
					       data);
...
static void
frame_contact_add_show(struct MessageNewViewData *data)
{
	struct Window *win = data->win;
	...
	data->list_contacts =
		elm_my_contactlist_add(window_evas_object_get(win));
	window_swallow(win, "list", data->list_contacts);
	evas_object_show(data->list_contacts);
}

static void
frame_contact_add_hide(struct MessageNewViewData *data)
{
	evas_object_del(data->bt1);
	evas_object_del(data->bt2);
...
static void
frame_contact_add_back_clicked(struct MessageNewViewData *data,
			       Evas_Object * obj, void *event_info)
{
...
static void
frame_contact_add_add_clicked(struct MessageNewViewData *data,
			      Evas_Object * obj, void *event_info)
{
	g_debug("frame_contact_add_add_clicked()");
	GHashTable *properties =
		elm_my_contactlist_selected_row_get(data->list_contacts);
	if (properties != NULL) {
		g_ptr_array_add(data->recipients, properties);
		data->mode = MODE_RECIPIENT;
		window_frame_show(data->win, data, frame_recipient_show,
...
static void
frame_number_add_hide(struct MessageNewViewData *data)
{
	evas_object_del(data->bt1);
	evas_object_del(data->bt2);
	evas_object_del(data->sc);
...
static void
frame_number_add_back_clicked(struct MessageNewViewData *data,
			      Evas_Object * obj, void *event_info)
{
	data->mode = MODE_RECIPIENT;
	window_frame_show(data->win, data, frame_recipient_show,
...
static void
frame_close_hide(struct MessageNewViewData *data)
{
	evas_object_del(data->bt1);
	evas_object_del(data->bt2);
...
static void
frame_close_yes_clicked(struct MessageNewViewData *data, Evas_Object * obj,
			void *event_info)
{
	window_destroy(data->win, NULL);
}
...
static void
frame_close_no_clicked(struct MessageNewViewData *data, Evas_Object * obj,
		       void *event_info)
{
	window_frame_show(data->win, data, frame_content_show,
			  frame_content_hide);
...
static void
frame_sending_show(struct MessageNewViewData *data)
{
...
static void
frame_sending_hide(struct MessageNewViewData *data)
{
